    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".category__slider")) new core(".category__slider", {
                ...
                navigation: {
                    prevEl: ".category__btn-prev.swiper-button-prev",
                    nextEl: ".category__btn-next.swiper-button-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1.5
            ...
            if (document.querySelector(".tranding__slider")) new core(".tranding__slider", {
                ...
                navigation: {
                    prevEl: ".tranding__btn-prev.swiper-button-prev",
                    nextEl: ".tranding__btn-next.swiper-button-next"
                },
                breakpoints: {
                    0: {
                        slidesPerView: 1,
        ...
        if (document.querySelectorAll(".collectioners__body")) mixitup(".collectioners__body");
        var buttons = document.querySelectorAll(".action-collectioners__btn");
